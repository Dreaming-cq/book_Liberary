...
.back {
  ...
  <c:forEach items="${bbook}" var="book">
 <tr>
   	<td><c:out value="${book.user.username }"></c:out></td>
    <td><c:out value="${book.user.realname }"></c:out></td>
    <td><c:out value="${book.user.sex}"></c:out></td>
    ...
    <td><a href="${book.book_id}/back/manager">已归还</a></td>
  </tr>
  </c:forEach>
  </table>
