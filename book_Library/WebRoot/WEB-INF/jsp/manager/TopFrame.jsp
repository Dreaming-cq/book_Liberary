...
<ul class="nav">
    ...
    <li><a href="show/manager" target="mainFrame">图书管理</a></li>
    <li><a href="show_user/manager" target="mainFrame">学生管理</a></li>
    <li><a href="show_borrow/manager" target="mainFrame">借阅管理</a></li>
